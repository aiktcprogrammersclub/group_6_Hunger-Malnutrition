...
if(isset($_POST["send"])){
	...
	$mail->AddReplyTo("siddiquamaazsk@gmail.com", "SFS"); //reply-to address
	$mail->SetFrom("siddiquamaazsk@gmail.com", "SFS"); //From address of the mail
	// put your while loop here like below,
	$mail->Subject = "Your Verification email"; //Subject od your mail
	$mail->AddAddress($email, "LocalHost Email"); //To address who will receive this email
	$mail->MsgHTML("<b>Hello</b>This is to verify your registration you can <a href=http://localhost/email/workingmail.php>click here</a> to login"); //Put your body of the message you can place html code here
   ...
   if($res)
     {
	  ...
	  echo '<center><h3 style="color:#009933;">There is some problem in inserting record</h3></center>';
